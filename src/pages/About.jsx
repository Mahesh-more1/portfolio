...
const About = () => {
  ...
  const skills = {
    ...
    "Tools & Cloud":         ["Docker (Learning)", "Git & GitHub", "Cloudinary", "Razorpay", "VS Code", "Firebase"],
  ...
  const experience = [
    ...
    },
    {
      ...
      description: "Completed hands-on web development tasks, front-end feature implementations, and project deliverables as part of the AICTE Corporate Internship program.",
    },
    {
      title: "AI & Data Analytics Virtual Intern",
      company: "AICTE, Shell India & Edunet Foundation",
      duration: "June – July 2025 · 4 Weeks",
    ...
    <AboutContainer>
      ...
      <AboutContent>
        ...
        >
          <div>
            ...
            <p>
              I specialize in full-stack web development and core CS fundamentals, crafting apps using <span className="highlight">React.js, C, C++, JavaScript, Node.js, Express, Python</span>, and <span className="highlight">Java</span>.
            </p>
            <p>
              Currently building my Final Year Major Project — a <span className="highlight">GenAI-powered University Knowledge System</span> using <span className="highlight">RAG, FastAPI</span>, and modern web frameworks.
            </p>
          </div>
          <Button
            primary
      ...
      <ScrollSection ref={eduRef} id="education-section">
        ...
        >
          <EduTopRow>
            ...
            <EduMainInfo>
              ...
              <BadgeRow>
                ...
                <Badge green><FiAward /> 8.2 CGPA</Badge>
              </BadgeRow>
            </EduMainInfo>
          </EduTopRow>
          ...
          <CourseworkLabel><FiCpu /> Core CS Coursework</CourseworkLabel>
          <CourseworkGrid>
      ...
      <CTACard>
        ...
        <Button
          ...
          whileTap={{ scale: 0.96 }}
          style={{ borderRadius: '9999px', padding: '0.78rem 2rem', fontSize: '0.9rem' }}
        >
          Say Hi <FiArrowRight />
        </Button>
      </CTACard>
